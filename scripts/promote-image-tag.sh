...
VALID_SERVICES=("portal" "portal-mcp" "user-management" "wallet" "risk-games" "notification" "job-scheduler" "identity" "budget-tracker" "health-care" "travel-calendar" "personal-food-advisor")
