...
using Defender.PersonalFoodAdvisor.Application.Modules.Module.Commands;
using FluentValidation;
using MediatR;

namespace Defender.PersonalFoodAdvisor.Tests.Handlers;

public class PersonalFoodAdvisorApplicationCoverageSmokeTests
{
    [Fact]
