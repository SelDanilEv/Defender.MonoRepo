...
using Defender.PersonalFoodAdvisor.Application.Configuration.Extension;
            ...
            .AddJwtBearer(options =>
            {
                ...
                options.Events = new JwtBearerEvents
                {
                    OnChallenge = context =>
                    {
                        ...
                        var detail = ErrorCodeHelper.GetErrorCode(ErrorCode.CM_InvalidUserJWT);
    ...
    private static IServiceCollection AddSwagger(this IServiceCollection services)
    {
        services.AddSwaggerGen(options =>
        {
            ...
            options.SwaggerDoc(
                ...
                {
                    Version = "v1",
                    Title = "Personal Food Advisor",
                    Description = "Personal Food Advisor",
                }
            );
