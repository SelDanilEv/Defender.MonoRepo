...
namespace Defender.Portal.Infrastructure.Clients.PersonalFoodAdvisor;

public interface IPersonalFoodAdvisorClient
{
    ...
    Task<IReadOnlyList<PortalMenuSessionDto>> GetSessionsAsync(CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<PortalDishRatingDto>> GetRatingsAsync(CancellationToken cancellationToken = default);
