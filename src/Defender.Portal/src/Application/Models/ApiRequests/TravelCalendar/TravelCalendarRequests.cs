...
public record CreateTravelEventRequest(long ExpectedVersion, string Title, string Type, DateOnly StartDate, DateOnly EndDate, string? Notes, bool HotelBooked, string? HotelName, string? HotelAddress, string? HotelBookingUrl, decimal HotelCostPln, decimal DistanceKm, string? MainPoint, decimal OtherCostPln);
