...
public record CreateTravelEventRequest(long ExpectedVersion, string Title, string Type, DateOnly StartDate, DateOnly EndDate, string? Notes, bool HotelBooked, string? HotelName, string? HotelAddress, string? HotelBookingUrl, decimal HotelCostPln, decimal TransportCostPln, string? MainPoint, decimal OtherCostPln);
public record UpdateTravelEventRequest(long ExpectedVersion, string Title, string Type, DateOnly StartDate, DateOnly EndDate, string? Notes, bool HotelBooked, string? HotelName, string? HotelAddress, string? HotelBookingUrl, decimal HotelCostPln, decimal TransportCostPln, string? MainPoint, decimal OtherCostPln);
