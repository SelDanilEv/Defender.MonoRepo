...
public record TravelCalendarDto(Guid Id, long Version, string BaseCity, string Currency, string Theme, VehicleSettingsDto Vehicle, IReadOnlyList<CalendarHolidayDto> Holidays, IReadOnlyList<TravelEventDto> Events, IReadOnlyList<PackingItemDto> PackingItems, TravelCalendarSummaryDto Summary, DateTimeOffset UpdatedAtUtc);
