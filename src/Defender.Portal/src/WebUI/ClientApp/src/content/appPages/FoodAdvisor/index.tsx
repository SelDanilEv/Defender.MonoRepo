...
const FoodAdvisorHomePage = () => {
  ...
  useEffect(() => {
    const loadPreferences = async () => {
      const data = await foodAdvisorApi.getPreferences(utilsRef.current);
      ...
      <Grid container spacing={2}>
          ...
          <Card sx={{ height: "100%" }}>
            <CardContent>
              <Typography variant="h6" gutterBottom>
                {u.t("foodAdvisor:preferences_likes_label")}
              </Typography>
              <Stack spacing={1.5}>
                <Box
                  sx={{
                ...
                <Box display="flex" gap={1} alignItems="center">
                  ...
                  <IconButton
                    ...
                    aria-label={u.t("foodAdvisor:add")}
                  >
                    <AddIcon />
                  </IconButton>
                </Box>
        ...
        <Grid item xs={12} sm={6}>
          <Card sx={{ height: "100%" }}>
            <CardContent>
              <Typography variant="h6" gutterBottom>
                {u.t("foodAdvisor:preferences_dislikes_label")}
              </Typography>
              <Stack spacing={1.5}>
                <Box
                  sx={{
        ...
        <Grid item xs={12}>
          ...
          <Box display="flex" gap={1} flexWrap="wrap">
            ...
            >
              {saving ? u.t("foodAdvisor:polling") : u.t("foodAdvisor:save")}
            </Button>
            <Button
              variant="outlined"
            ...
            <Button
              variant="outlined"
              onClick={() => navigate("/food-advisor/sessions")}
            >
              {u.t("foodAdvisor:sessions_manage")}
            </Button>
          </Box>
        </Grid>
      </Grid>
...
export default connect(mapStateToProps)(FoodAdvisorHomePage);
