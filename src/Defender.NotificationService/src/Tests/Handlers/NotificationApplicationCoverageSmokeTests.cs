...
namespace Defender.NotificationService.Tests.Handlers;

public class NotificationApplicationCoverageSmokeTests
{
    [Fact]
    public void Validators_WhenConstructedAndValidated_DoNotCrash()
    {
        var assembly = typeof(SendPureEmailCommand).Assembly;
