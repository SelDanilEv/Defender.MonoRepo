...
namespace Defender.IdentityService.Tests.Handlers;

public class IdentityServiceApplicationCoverageSmokeTests
{
    [Fact]
    public void Validators_WhenConstructedAndValidated_DoNotCrash()
    {
        var assembly = typeof(VerifyCodeCommand).Assembly;
