...
public record TravelCalendarDto(Guid Id, long Version, string BaseCity, string Currency, CalendarTheme Theme, VehicleSettingsDto Vehicle, IReadOnlyList<CalendarHolidayDto> Holidays, IReadOnlyList<TravelEventDto> Events, IReadOnlyList<PackingItemDto> PackingItems, TravelCalendarSummaryDto Summary, DateTimeOffset UpdatedAtUtc);
