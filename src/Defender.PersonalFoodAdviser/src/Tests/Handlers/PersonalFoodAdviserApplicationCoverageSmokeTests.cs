...
using Defender.PersonalFoodAdviser.Application.Modules.Module.Commands;
using FluentValidation;
using MediatR;

namespace Defender.PersonalFoodAdviser.Tests.Handlers;

public class PersonalFoodAdviserApplicationCoverageSmokeTests
{
    [Fact]
